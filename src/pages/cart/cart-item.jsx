...
export const CartItem = (props) => {
    const { id, nombre, precio, img } = props.data; //con los props recibimos los datos extraidos de los productos y los almacenamos en las variables
    const { cartItems, addToCart, removeFromCart } = useContext(ShopContext);//almacenamos el context dentro de esas variables
    return  (
        <div className="cartItem">
            <img src={require(`../../img/${img}`)} alt={nombre}/>{/*se muestra la primera imagen del producto */}
